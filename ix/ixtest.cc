...
{    
    ...
    // Test Open Scan
    rc = ixScan->OpenScan(ixHandle, NULL, NULL, true, true);
    if(rc == success) 
    {
...
{    
    ...
    rc= ixScan->OpenScan(ixHandle, &value, NULL, true, true);
    if(rc == success)
    {
        cout << "Scan Opened Successfully!" << endl;
    }
...
void testCase_6(const string tablename, const string attrname)
{
    ...
    rc = ixScan->OpenScan(ixHandle, NULL, &compVal, true, false);
    if(rc == success)
    {
        cout << "Scan Opened Successfully!" << endl;
    }
...
void testCase_7(const string tablename, const string attrname)
{
    ...
    rc = ixScan->OpenScan(ixHandle, NULL, &compVal, true, true);
    if(rc == success)
    {
        cout << "Scan Opened Successfully!" << endl;
    }
...
void testCase_8(const string tablename, const string attrname)
{
    ...
    // Test Scan
    compVal = 450.0;
    rc = ixScan->OpenScan(ixHandle, &compVal, NULL, false, true);
    if(rc == success)
    {
        cout << "Scan Opened Successfully!" << endl;
    }

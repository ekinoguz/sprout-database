...
void testCase_O7()
{
  ...
  cout << "...it might take time, be patient..." << endl << endl;
  vector<RID> rids;
  // Test InsertEntry
  const unsigned first      = 100000;
  const unsigned firstEnd   = 200000;
  const unsigned second     = 300000;
  const unsigned secondEnd  = 600000;
  string entry;
